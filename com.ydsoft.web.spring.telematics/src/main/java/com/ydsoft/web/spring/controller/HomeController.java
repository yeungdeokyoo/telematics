...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		...
		model.addAttribute("name", "Yeungdeok yoo" );
		model.addAttribute("data", "YD Yoo" );
	...
	public String redirected(Locale locale, Model model) {
		logger.info("Redirected page.");
	 ...
	 * Simply selects the home view to render by returning its name.
	 */
	@RequestMapping(value = "/calAPI", method = RequestMethod.GET)
	public void calAPI(Locale locale, Model model) {
		logger.info("Calendar API.");
